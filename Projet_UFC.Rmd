...
# KMeans clustering
```{r}
# On utilise 3 classes ici.

classification <- kmeans(scaledQuantitativeVariables, centers = 3)
classification$cluster

BSS <- classification$betweenss
TSS <- classification$totss
qualityPartition = (BSS / TSS) * 100
```
