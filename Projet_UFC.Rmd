...
Pour pouvoir effectuer une analyse en composante principale, on va devoir utiliser le package FactoMineR. Nous devons sélectionner les variables continues de notre dataset final. Après cela, nous allons visualiser les valeurs propres en fonction des composantes afin de sélectionner quelle composantes nous devons choisir pour notre analyse.
```{r}
library(FactoMineR)
...
Par une règle générale, on sélectionne les composantes tq leurs valeurs propres  soient plus grande que 0.
```{r}
